...
Public Class FormLineaGeneraleFormazione
    ...
    Private Sub RegistraCausale(Id As String, Desc As String)
        ...
        myCmd2.CommandText = ("UPDATE Fermi SET IdMacchina=0,DescMacchina='Linea Generale',IdFermo=" & Id & ",DescFermo='" & Desc & "',DescFermoEsteso='" & TextBoxLineaGeneraleFormazione.Text & "' WHERE (Id=" & Form1.LabelIdFermo.Text & " AND IdReparto=" & Form1.LblIdDepartment.Text & " AND IdLinea=" & Form1.LblIdLinea.Text & ")")
    ...
    Private Sub ButtonAssembleaSciopero_Click(sender As Object, e As EventArgs) Handles ButtonAssembleaSciopero.Click
    ...
    Private Sub ButtonMancanzaAcidoSolforico_Click(sender As Object, e As EventArgs) Handles ButtonMancanzaAcidoSolforico.Click
        RegistraCausale("14", "Mancanza acido solforico")
        UpdateForm1()
        Me.Close()
    End Sub

    Private Sub ButtonCambioTipoProduzione_Click(sender As Object, e As EventArgs) Handles ButtonCambioTipoProduzione.Click
