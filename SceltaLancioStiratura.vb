...
Public Class SceltaLancioStiratura

    Private Sub SceltaLancioStiratura_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        LabelCodiceLinea.Text = CodiceLinea
        ...
        If myCmd.ExecuteScalar() = 0 Then
            ...
            myCmd2.CommandText = "SELECT * FROM LanciProduzione WHERE (Linea='" & LabelCodiceLinea.Text & "') AND ((StatoLancio='Sospeso') OR (StatoLancio IS NULL))"
            ...
            LabelCavalletti.Visible = False
            LabelPiastre.Visible = False
            TextBoxCavalletti.Visible = False
            TextBoxProduzionePiastre.Visible = False
        ...
        Else
            ...
            myCmd4.CommandText = "SELECT Turno FROM Produzione WHERE ((Lancio='" & TextBoxLancioProduzione.Text & "') AND (IdLinea='" & Form1.LblIdLinea.Text & "') AND (DataFine IS NULL))"
    ...
    Private Sub TextBoxLancioProduzione_TextChanged(sender As Object, e As EventArgs) Handles TextBoxLancioProduzione.TextChanged
        ...
        If TextBoxLancioProduzione.Text.Length >= 3 Then
            ...
            Dim myCmd As SqlCommand
            myCmd = myConn.CreateCommand()
            myCmd.CommandText = "SELECT Materiale FROM LanciProduzione WHERE ((Ordpian='" & TextBoxLancioProduzione.Text & "') AND (Linea='" & LabelCodiceLinea.Text & "'))"
            myCmd.Connection.Open()
            ...
            Else
                ...
                Dim myCmd2 As SqlCommand
                myCmd2 = myConn.CreateCommand()
                myCmd2.CommandText = "SELECT ([Qtà Ordine]) FROM LanciProduzione WHERE ((Ordpian='" & TextBoxLancioProduzione.Text & "') AND (Linea='" & LabelCodiceLinea.Text & "'))"
                myCmd2.Connection.Open()
                ...
                Dim myCmd3 As SqlCommand
                myCmd3 = myConn.CreateCommand()
                myCmd3.CommandText = "SELECT QuantitàMancante FROM LanciProduzione WHERE ((Ordpian='" & TextBoxLancioProduzione.Text & "') AND (Linea='" & LabelCodiceLinea.Text & "'))"
                myCmd3.Connection.Open()
    ...
    Private Sub ButtonConfermaLancio_Click(sender As Object, e As EventArgs) Handles ButtonConfermaLancio.Click
        ...
        Else
            ...
            Dim myCmd3 As SqlCommand
            myCmd3 = myConn.CreateCommand()
            myCmd3.CommandText = "UPDATE LanciProduzione SET StatoLancio ='In corso' WHERE ((Ordpian ='" & TextBoxLancioProduzione.Text & "') AND (Linea ='" & LabelCodiceLinea.Text & "'))"
            myCmd3.Connection.Open()
            ...
            LabelCavalletti.Visible = True
            LabelPiastre.Visible = True
            TextBoxCavalletti.Visible = True
            TextBoxProduzionePiastre.Visible = True
    ...
    Private Sub ButtonChiudiLancio_Click(sender As Object, e As EventArgs) Handles ButtonChiudiLancio.Click
        ...
        If TextBoxProduzionePiastre.Text = "" Then
            MsgBox("Inserire il numero di piastre prodotti")
            Exit Sub
        Else
        End If

        If TextBoxCavalletti.Text = "" Then
            MsgBox("Inserire il numero di cavalletti prodotti")
            Exit Sub
        Else
        End If
        ...
        myCmd3.CommandText = "UPDATE Produzione SET DataFine='" & DataFormatting(DateTime.Now) & "', Pallett='" & TextBoxCavalletti.Text & "', Produzione = '" & TextBoxProduzionePiastre.Text & "', Minuti = '" & (CInt(TotalMinutesDuration) - CInt(Durata)).ToString & "'  WHERE (IdReparto='" & Form1.LblIdDepartment.Text & "' AND IdLinea='" & Form1.LblIdLinea.Text & "' AND DataFine IS NULL)"
        myCmd3.Connection.Open()
        myCmd3.ExecuteNonQuery()
        myCmd3.Connection.Close()
        ...
        Dim myCmd4 As SqlCommand
        myCmd4 = myConn.CreateCommand()
        myCmd4.CommandText = "UPDATE LanciProduzione SET QuantitàMancante = '" & (CInt(LabelQuantitàMancante.Text) - CInt(TextBoxProduzionePiastre.Text)).ToString & "' WHERE ((Ordpian ='" & TextBoxLancioProduzione.Text & "') AND (Linea ='" & LabelCodiceLinea.Text & "'))"
        myCmd4.Connection.Open()
        myCmd4.ExecuteNonQuery()
        myCmd4.Connection.Close()

        If (CInt(LabelQuantitàMancante.Text) - CInt(TextBoxProduzionePiastre.Text)) <= 0 Then
            Dim myCmd5 As SqlCommand
            myCmd5 = myConn.CreateCommand()
            myCmd5.CommandText = "UPDATE LanciProduzione SET StatoLancio = 'Chiuso' WHERE ((Ordpian ='" & TextBoxLancioProduzione.Text & "') AND (Linea ='" & LabelCodiceLinea.Text & "'))"
        ...
        Else
            ...
            myCmd6.CommandText = "UPDATE LanciProduzione SET StatoLancio = 'Sospeso' WHERE ((Ordpian ='" & TextBoxLancioProduzione.Text & "') AND (Linea ='" & LabelCodiceLinea.Text & "'))"
        ...
        TextBoxCavalletti.Text = ""
        TextBoxProduzionePiastre.Text = ""
        ...
        myCmd10.CommandText = "SELECT * FROM LanciProduzione WHERE (Linea='" & LabelCodiceLinea.Text & "') AND ((StatoLancio='Sospeso') OR (StatoLancio IS NULL))"
    ...
    Private Sub ButtonSalvaTurno_Click(sender As Object, e As EventArgs) Handles ButtonSalvaTurno.Click
        ...
        Else
            ...
            Dim myCmd3 As SqlCommand
            myCmd3 = myConn.CreateCommand()
            myCmd3.CommandText = "UPDATE Produzione SET DataFine='" & DataFormatting(DateTime.Now) & "', Pallett='" & TextBoxCavalletti.Text & "', Produzione = '" & (CInt(TextBoxProduzionePiastre.Text)).ToString & "', Minuti = '" & (CInt(TotalMinutesDuration) - CInt(Durata)).ToString & "' WHERE (IdReparto='" & Form1.LblIdDepartment.Text & "' AND IdLinea='" & Form1.LblIdLinea.Text & "' AND DataFine IS NULL)"
            myCmd3.Connection.Open()
            myCmd3.ExecuteNonQuery()
            myCmd3.Connection.Close()

            LabelQuantitàMancante.Text = (CInt(LabelQuantitàMancante.Text) - CInt(TextBoxProduzionePiastre.Text)).ToString

            Dim myCmd4 As SqlCommand
            myCmd4 = myConn.CreateCommand()
            myCmd4.CommandText = "UPDATE LanciProduzione SET QuantitàMancante = '" & LabelQuantitàMancante.Text & "' WHERE ((Ordpian ='" & TextBoxLancioProduzione.Text & "') AND (Linea ='" & LabelCodiceLinea.Text & "'))"
            myCmd4.Connection.Open()
            myCmd4.ExecuteNonQuery()
            myCmd4.Connection.Close()
